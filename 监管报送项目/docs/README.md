...
| [kg-and-agent-enhancement-design.md](kg-and-agent-enhancement-design.md) | **AI 工程方法论加固**：业务知识图谱可视化 + Self-Correcting + ReAct Tool-Using Agent，提升演示与抗追问能力 | 2026-05-27 |
| [feasibility-audit.md](feasibility-audit.md) | **立项可信度自评**：11 模块追问清单 + 答案 + 30 秒话术，经得起领导追问 | 2026-05-27 |
